...
## Deploy Catalog
In order to use Catalog Manager, make sure that you have successfully deployed [Catalog](./ircatalog.md).
...
## Create Web App
Create the [Microsoft Azure App Service Web App](https://docs.microsoft.com/en-us/azure/app-service/app-service-web-overview) for Catalog Manager with the [az webapp create](https://docs.microsoft.com/en-us/cli/azure/webapp#az-webapp-create) command:
```powershell
...
Verify your deployment is successfully configured by visiting Catalog Manager in your browser with the [az webapp browse](https://docs.microsoft.com/en-us/cli/azure/webapp?view=azure-cli-latest#az-webapp-browse) command and logging in:
```powershell
