...
Before creating and deploying the irServer Rule Execution Service package, the follow the steps below to log into Azure and set up the initial resources:
